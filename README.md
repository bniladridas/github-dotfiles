...
For a new Mac, first run the setup script to install Zsh, Homebrew, Python, Node.js, Ruby, Rust, GitHub CLI, Docker CLI, and opencode. It also offers to log in to Docker Hub as 'harpertoken':
